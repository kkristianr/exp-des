...
# FM on ml_1m: alpha=0.9, beta=1.0
# NFM on ml_1m: alpha=0.7, beta=1.0
# FM on amazon_book: alpha=1.0, beta=1.0
# NFM on amazon_book: alpha=1.0, beta=1.0
# counterfactual inference alpha<1.0 is not very useful on amazon_book.
# this is because it only has user ID representations.
